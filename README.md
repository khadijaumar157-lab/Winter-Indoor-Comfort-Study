...
1. Explore the raw data in `data/`.  
2. Review the analysis in `analysis/`.  
3. Visualizations in `figures/` provide quick insights.  
4. The complete methodology, results, and reflections are detailed in `report/Winter_Indoor_Comfort_Study.pdf`.
